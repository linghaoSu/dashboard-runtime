...
import bizGroupMapping from '@dao-style/biz/dist/group-mapping.json';
    ...
    rspack: {
      ...
      plugins: [
        ...
        daoStyleUnpluginExtend([
          ...
          {
            mapping: bizGroupMapping,
            // 按需添加, 如果项目无需 ws 切换功能, 可以选择移除
            specialImportMapping: {
              useWorkspaceSwitch: ['switch-workspace-dialog'],
            },
            lib: '@dao-style/biz',
          },
        ]),
